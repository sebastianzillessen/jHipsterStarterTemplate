...
The following options where used to generate this Template:

- Which *type* of application would you like to create? `Monolithic application (recommended for simple projects)`
- What is the base name of your application? `jHipsterStarterTemplate`
- What is your default Java package name? `ch.zuehlke.jhipsterstarter`
...
- Which other technologies would you like to use? Social login (Google, Facebook, Twitter), API first development using swagger-codegen
...
To optimize the jHipsterStarterTemplate application for production, run:
